...
# Read all JSON files from the sweep_horizon directory
sweep_dir = Path("profile/sweep_horizon")
data = []
...
ax1.set_title('Time vs Horizon Length', fontsize=14)
ax1.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('profile/sweep_horizon/time_vs_horizon.png', dpi=150)
...
ax2.set_title('Success Rate vs Horizon Length', fontsize=14)
ax2.set_ylim([0, 1.1])
ax2.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('profile/sweep_horizon/success_vs_horizon.png', dpi=150)
